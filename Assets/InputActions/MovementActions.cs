...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/InputActions/MovementActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @MovementActions: IInputActionCollection2, IDisposable
{
    ...
    ~@MovementActions()
    {
        UnityEngine.Debug.Assert(!m_CRMovement.enabled, "This will cause a leak and performance issues, MovementActions.CRMovement.Disable() has not been called.");
    }
